...
pub fn get_specta_builder() -> tauri_specta::Builder {
    let builder = tauri_specta::Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        crate::cmd::update_doc_title,
        crate::cmd::delete_doc,
        crate::cmd::create_journal,
        crate::cmd::get_journals,
        crate::cmd::get_journals_by_date_range,
        crate::cmd::delete_journal,
    ...
    builder
        .export(
            ...
            "../apps/client/src/api/bindings.gen.ts",
        )
