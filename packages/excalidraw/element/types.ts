...
export type MarkerBrush = "highlighter" | "marker";
export type MarkerBlendMode = "normal" | "multiply";

export type ExcalidrawMarkerElement = Omit<
  ExcalidrawFreeDrawElement,
  "type"
> &
  Readonly<{
    ...
    /** Controls how much pressure changes the marker width. */
    pressureThinning: number;
  }>;
