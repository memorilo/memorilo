...
export const isFreeDrawElement = (
  element?: ExcalidrawElement | null,
): element is ExcalidrawFreeDrawElement | ExcalidrawMarkerElement => {
...
export const isFreeDrawElementType = (
  ...
  return elementType === "freedraw" || elementType === "marker";
};

export const isMarkerElement = (
  element?: ExcalidrawElement | null,
): element is ExcalidrawMarkerElement => {
