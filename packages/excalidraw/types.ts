...
export interface AppState {
  ...
  currentItemMarkerBrush: MarkerBrush;
  currentItemMarkerBlendMode: MarkerBlendMode;
  currentItemMarkerPressureThinning: number;
  currentItemMarkerStrokeWidth: number;
