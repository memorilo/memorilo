    ...
    return {
      elements: elements.map((element) => {
        if (selectedElementIds.includes(element.id)) {
          ...
          if (
            newElement.type === "marker" &&
            elementStylesToCopyFrom.type === "marker"
          ) {
            newElement = newElementWith(newElement, {
              brush: elementStylesToCopyFrom.brush,
              blendMode: elementStylesToCopyFrom.blendMode,
              pressureThinning: elementStylesToCopyFrom.pressureThinning,
            });
          }
