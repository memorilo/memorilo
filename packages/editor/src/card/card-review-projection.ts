...
import type { CardReviewOptions } from './card-review-runtime'
...
export function createCardReviewDecorations(
...
export function syncCardReviewMathDisplays(view: EditorView, options: CardReviewOptions): void {
