...
import type { EditorEmbeddedDocument, EditorWhiteboardTopicDocument } from '../note/editor-note'
...
import { whiteboardSceneSignature } from '../note/editor-note-whiteboard'
import { whiteboardEditorStyles } from './whiteboard-editor.stylex'
import '@excalidraw/excalidraw/index.css'

export type WhiteboardLibraryPersistenceAdapter = LibraryPersistenceAdapter
...
export interface WhiteboardEditorProps {
  ...
  learningEnabled: boolean
  libraryPersistenceAdapter: LibraryPersistenceAdapter
