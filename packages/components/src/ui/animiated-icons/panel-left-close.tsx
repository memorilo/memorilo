...
function PanelLeftCloseIcon({ ref, onMouseEnter, onMouseLeave, className, size = 28, ...props }: PanelLeftCloseIconProps & { ref?: React.RefObject<PanelLeftCloseIconHandle | null> }) {
