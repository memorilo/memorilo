...
function CalendarCheckIcon({ ref, onMouseEnter, onMouseLeave, className, size = 28, ...props }: CalendarCheckIconProps & { ref?: React.RefObject<CalendarCheckIconHandle | null> }) {
