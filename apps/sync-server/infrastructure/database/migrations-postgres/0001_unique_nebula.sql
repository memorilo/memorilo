...
CREATE UNIQUE INDEX "sync_asset_manifests_identity" ON "sync_asset_manifests" USING btree ("account_id","generation","device_id","sequence");--> statement-breakpoint
CREATE UNIQUE INDEX "sync_asset_manifests_id" ON "sync_asset_manifests" USING btree ("account_id","generation","id");