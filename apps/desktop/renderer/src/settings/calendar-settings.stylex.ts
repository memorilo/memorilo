...
export const calendarSettingsStyles = stylex.create({
  ...
  addForm: {
    ...
    borderRadius: 8,
    backgroundColor: {
      'default': 'rgba(118, 118, 128, 0.055)',
      '@media (prefers-color-scheme: dark)': 'rgba(255, 255, 255, 0.045)',
    },
  },
  field: {
    display: 'grid',
  ...
  input: {
    ...
    'backgroundColor': {
      ...
      '@media (prefers-color-scheme: dark)': 'rgba(20, 22, 27, 0.52)',
    },
    'color': 'inherit',
    'fontFamily': 'inherit',
    'fontSize': 11,
  ...
  secondaryButton: {
    'height': 28,
    'borderColor': 'rgba(80, 87, 98, 0.16)',
    'borderStyle': 'solid',
    'borderWidth': 1,
    'borderRadius': 6,
    'paddingInline': 11,
