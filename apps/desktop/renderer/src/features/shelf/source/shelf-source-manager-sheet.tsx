    ...
    <AnimatePresence>
      {open
        ? (
            ...
            >
              <button
                {...stylex.props(shelfSourceDialogStyles.sheetScrim)}
                aria-label={t('shelfCloseBookSources')}
                disabled={isPending}
                type="button"
                onClick={onClose}
              />
              <motion.section
                ref={dialogRef}
                {...stylex.props(shelfSourceManagerStyles.sheet)}
                animate={sheetAnimate}
                aria-labelledby="shelf-source-manager-title"
                aria-modal="true"
                exit={sheetExit}
                initial={sheetExit}
                role="dialog"
