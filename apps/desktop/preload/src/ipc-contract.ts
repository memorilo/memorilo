...
export const desktopIpcChannels = {
  ...
  learning: {
    answerAnkiReviewCard: 'memorilo:invoke:learning:answerAnkiReviewCard',
    ...
    listAnkiDecks: 'memorilo:invoke:learning:listAnkiDecks',
    ...
    playAnkiReviewAudio: 'memorilo:invoke:learning:playAnkiReviewAudio',
    ...
    retrieveAnkiMediaFile: 'memorilo:invoke:learning:retrieveAnkiMediaFile',
    restoreReviewItem: 'memorilo:invoke:learning:restoreReviewItem',
    saveOptimizer: 'memorilo:invoke:learning:saveOptimizer',
    showAnkiReviewAnswer: 'memorilo:invoke:learning:showAnkiReviewAnswer',
    startAnkiDeckReview: 'memorilo:invoke:learning:startAnkiDeckReview',
