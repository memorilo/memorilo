...
- [ ] On hardware, verify application-triggered notification, server-triggered notification, offline cache, button input during refresh, partial refresh behavior, and front-light state.
